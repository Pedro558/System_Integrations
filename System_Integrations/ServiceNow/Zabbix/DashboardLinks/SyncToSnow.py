...
from System_Integrations.classes.requests.zabbix.dataclasses import EnumSyncType
...
request = SyncProductLinksSnow(db, targetSystem, dataType=EnumSyncType.HIST)
request.run()