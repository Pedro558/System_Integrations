...
for result in results:
            ...
            if response.status_code == 200 or response.status_code == 201:
                print(f"Updated {result['item']['u_ticket_gestao_x.u_ticket_gestao_x']} with the update from {result['item']['u_data_da_atualizacao']}")
            else:
                print(f"Error while trying to update ticket {result['item']['u_ticket_gestao_x.u_ticket_gestao_x']} with the update from {result['item']['u_data_da_atualizacao']}")
